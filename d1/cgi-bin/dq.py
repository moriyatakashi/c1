...
bytes_str =     "00000"        + BItown + BIroName[2]    + BIroName[1][:2]+ BIgold[:8]+ \
             BIroName[1][3:5]+ BIroName[0]+ BIgold[8:]+ BIroName[1][5]    + BIroName[3]       + BIroName[1][2]+ \
             ...
             "00000000"+ BIroExp[4:]+ BIroExp[0:4]      + BIroItemsLen+ "".join(BIroItems)+ BIsaFlag
...
bytes_str =     "00000"        + BItown + BIroName[2]    + BIroName[1][:2]+ BIgold[:8]+ \
             ...
             "00000000"+ BIroExp[4:]+ BIroExp[0:4]      + BIroItemsLen+ "".join(BIroItems)+ BIsaFlag
bytes = split_string(bytes_str)
bytes_str =     "00000"        + BItown + BIroName[2]    + BIroName[1][:2]+ BIgold[:8]+ BIroName[1][3:5]+ BIroName[0]+ \
             BIgold[8:]+ BIroName[1][5]    + BIroName[3]       + BIroName[1][2]+ \
             BIpattern[3] + BIflagMoon + BIflagGate + BIflagPlumage + BIstatShip + BIstatPrince+ \
             BIpattern[0:3]   + BIcrestLife      + BIcrestWater + BIcrestMoon + BIcrestStar + BIcrestSun+ \
             "00000000"+ BIroExp[4:]+ BIroExp[0:4]      + BIroItemsLen+ "".join(BIroItems)+ BIsaFlag
bytes = split_string(bytes_str)
...
open("a.txt", "w", encoding="utf8").write(crc + "\n" + shape_jumon(jumon))
